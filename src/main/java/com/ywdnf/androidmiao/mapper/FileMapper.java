...
public interface FileMapper {
    ...
    @Select("select grfn();")
    Integer getFileRandomNo() throws Exception;


    @Delete("delete from file_lists where id = #{id} and binary file_post_author = #{userId}")
    Integer removeFileById(@Param("userId") String un, @Param("id") String bring_id) throws Exception;
